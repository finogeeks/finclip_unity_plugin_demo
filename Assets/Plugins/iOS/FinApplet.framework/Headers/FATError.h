...
typedef NS_ENUM(NSUInteger, FATErrorCode) {
    ...
    FATErrorCodeSDKConfigIsEmpty = 10004, // SDK配置信息为空
    ...
    FATErrorCodeFrameworkResourceNotFound = 12003,  //基础库资源不存在
    FATErrorCodeCopyFrameworkResourceFail = 12004,  //拷贝基础库资源失败
    FATErrorCodeMiniprogramResourceNotFound = 12005, //小程序资源不存在
    FATErrorCodeCopyMiniprogramResourceFail = 12006, //拷贝小程序资源失败
    ...
    FATErrorCodeNotExamineAccess = 13005,   // 没有审核权限
    FATErrorCodeNotDevelopAccess = 13006,   // 没有开发权限

    FATErrorCodeAppletNotFound = 14000,          // 未找到appletId指定小程序
    FATErrorCodeForegroundAppletNotFound = 14001,// 未找到前台运行的小程序
    FATErrorCodeAppletConsoleNotReady = 14002    // 小程序控制台未准备好
};
